...
// ),
  ...
  [_GAMEBASIC] = LAYOUT_charybdis_3x5_wrapper(
  //,--------------------------------------------.                    ,--------------------------------------------.
      ______________GAMEBASIC_L1________________,                      ______________GAMEBASIC_R1________________,
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      ______________GAMEBASIC_L2________________,                      ______________GAMEBASIC_R2________________,
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      ______________GAMEBASIC_L3________________,                      ______________GAMEBASIC_R3________________,
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
              ______________GAMEBASIC_LT________________,    ______________GAMEBASIC_RT________________
                            //`--------------------------'   `--------------------------'
),
...
[_WOW] = LAYOUT_charybdis_3x5_wrapper(
    //,--------------------------------------------.                    ,--------------------------------------------.
        ___________________WOW_L1__________________,                      ___________________WOW_R1__________________,
    //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
        ___________________WOW_L2__________________,                      ___________________WOW_R2__________________,
    //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
        ___________________WOW_L3__________________,                      ___________________WOW_R3__________________,
    //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                ___________________WOW_LT__________________,    ___________________WOW_RT__________________
                              //`--------------------------'   `--------------------------'
  ),
  ...
  [_SEC] = LAYOUT_charybdis_3x5_wrapper(
  //,--------------------------------------------.                    ,--------------------------------------------.
      _________________SEC_L1____________________,                      _________________SEC_R1____________________,
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      _________________SEC_L2____________________,                      _________________SEC_R2____________________,
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      _________________SEC_L3____________________,                      _________________SEC_R3____________________,
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                _________________SEC_LT____________________,      _________________SEC_RT____________________
                            //`--------------------------'   `--------------------------'
),
